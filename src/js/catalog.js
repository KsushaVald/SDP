document.addEventListener ('DOMContentLoaded', function() {
  ...
  let inputOne = document.getElementById("inputSlider-1");
  let inputTwo = document.getElementById("inputSlider-2");
  ...
  slider.noUiSlider.on('update', function (values, handle) {
    ...
    if (handle) {
        inputTwo.value = costView(Math.round(value));
    } else {
        inputOne.value = costView(Math.round(value));
    }
  });
